...
public class gParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_declarationList = 1, RULE_declaration = 2, RULE_type = 3, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "declarationList", "declaration", "type", "statementList", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 5066549594050816L) != 0)) {
				{
				setState(72);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ThenBlockContext thenBlock() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 562949966680320L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
